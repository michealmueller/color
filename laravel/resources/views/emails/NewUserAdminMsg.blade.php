        ...
        <table style="font-size: 0px; width: 100%; background: #ffb300;" role="presentation" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
                <td style="text-align: center; vertical-align: top; direction: ltr; font-size: 0px; padding: 20px 0px;"><!-- [if mso | IE]>
                    ...
                    <![endif]-->
                    <div class="" style="cursor: auto; color: #fff; font-family: Ubuntu, Helvetica, Arial, sans-serif; font-size: 18px; line-height: 22px; text-align: center;">A new user has registerd!</div>
                    <!-- [if mso | IE]>
                    </td>
                    </tr>
                    </table>
                            ...
                            <tr>
                                <td style="word-break: break-word; font-size: 0px; padding: 10px 25px;" align="left">
                                    <div class="" style="cursor: auto; color: #000000; font-family: Ubuntu, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; text-align: left;">
                                        <p style="font-size: 14px; color: #333;">There is a new user Registration.<br /> <a href="{{ route('adminhome') }}/authorize">Check new registration.</a> <br /><br /> This email has been sent to all administators.</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="word-break: break-word; font-size: 0px; padding: 10px 25px;" align="left">&nbsp;</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
